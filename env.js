 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.pawsconnect.staging
 */

const BUNDLE_ID = 'com.pawsconnect'; // ios bundle id
const PACKAGE = 'com.pawsconnect'; // android package name
const NAME = 'PawsConnect'; // app name
